...
class ParlayIVF(BaseFilterANN):
    ...
    def fit(self, dataset):
        ...
        self.index.fit_from_filename(ds.get_dataset_fn(), os.path.join(ds.basedir, ds.ds_metadata_fn), self._cutoff, self._cluster_size, "", self._weight_classes, False)
    ...
    def load_index(self, dataset):
        ...
        print("Index initialized")
        self.index.fit_from_filename(ds.get_dataset_fn(), os.path.join(ds.basedir, ds.ds_metadata_fn), self._cutoff, self._cluster_size, "", self._weight_classes, True)
        # self.index.print_stats()
