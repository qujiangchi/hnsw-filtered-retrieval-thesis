...
class AcornGamma(BaseFilterANN):
    ...
    def __init__(self, metric, index_params):
        ...
        self.gamma = int(index_params.get('gamma', 2))
        self.m_beta = int(index_params.get('m_beta', 2))
        self.bruteforce_selectivity_threshold = float(index_params.get('bruteforce_selectivity_threshold', 0.05))
